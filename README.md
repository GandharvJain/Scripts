...
* **spotifyControlsAPI.py**: Play/pause, go to next track, go to previous track and add (remove) current playing song on spotify to (from) existing playlist using spotipy module (Spotify API).
